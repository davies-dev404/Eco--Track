...
const globalStats = [
  {
    ...
    value: "50,000 tons",
    description: "Equivalent to taking 10,000 cars off the road",
    icon: Wind,
    color: "text-blue-500",
    bg: "bg-blue-100",
  },
  {
    label: "Water Saved",
    value: "2.5M liters",
    description: "Enough to fill 1,000 olympic swimming pools",
    icon: Droplets,
    color: "text-cyan-500",
    bg: "bg-cyan-100",
  },
  {
    label: "Trees Saved",
    value: "15,000+",
    description: "Forest area the size of Central Park",
    icon: TreeDeciduous,
...
const impactData = [
  { year: '2020', waste: 400, recycled: 120 },
  { year: '2021', waste: 380, recycled: 180 },
  { year: '2022', waste: 350, recycled: 250 },
  { year: '2023', waste: 300, recycled: 280 },
  { year: '2024', waste: 250, recycled: 350 },
  { year: '2025', waste: 200, recycled: 400 },
];
